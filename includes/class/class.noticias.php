...
class TNoticia extends PropertyObject {
    protected $_tablename	= 'noticias';
	protected $_fieldid		= 'idnt';
	protected $_fieldactivo	= 'ntactiva';
    ...
    public function __construct($_id=NULL) {
		...
		$this->propertyTable['ID'] 					= 'idnt';
		$this->propertyTable['Titulo']				= 'nttitulo';
		$this->propertyTable['Descripcion'] 		= 'ntdescripcion';	
		$this->propertyTable['Link'] 				= 'ntlink';		
		$this->propertyTable['Fecha'] 				= 'ntfecha';
		$this->propertyTable['Activa'] 				= 'ntactiva';
    }
