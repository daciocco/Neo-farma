        ...
        <tbody><?php 
			...
			if ($_abms) {
				foreach ($_abms as $k => $_abm){
					...
					$_abmIdCondPago= 	$_abm['abmcondpago'];	
					
					$condPlazo	=	DataManager::getCondicionDePagoTransfer('conddias', 'condid', $_abmIdCondPago);
                    ...
                    <?php if($_tipodrog == 'B'){ ?>
                   		<tr >
                            ...
                            <td ></td><td ></td>
                        	<td align="center"><?php echo $condPlazo; ?></td>
                   		...
                   		<tr >
                        	...
                        	<td align="center" style="width:50px;">TL</td>                         
							<?php $_artean	= DataManager::getArticulo('artcodbarra', $_abmArtid, 1, 1); ?>
