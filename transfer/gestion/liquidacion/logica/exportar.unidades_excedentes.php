...
header("content-disposition: attachment;filename=Liquidacion-Unidades-Excedentes-".$_drogid.".xls");	
?>
    	...
    	<table id="tblliquidaciones">
			...
			<tbody id="lista_liquidacion">
                ...
                if ($_transfers_liquidados) {
                    ...
                    <tr>
                        <td scope="colgroup" colspan="3" height="25" align="center">No hay Transfer con UNIDADES EXCEDENTES</td>
                    </tr> <?php
                } ?>
        	</tbody>
        </table>
